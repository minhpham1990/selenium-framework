package com.demo.pages.ui.common;

import org.openqa.selenium.By;

public class TopMenuUI {
    public static final By TOPMENU_HOME = By.xpath("//a[text()='Home ']");
    public static final By TOPMENU_CONTACT = By.xpath("//a[text()='Contact']");
